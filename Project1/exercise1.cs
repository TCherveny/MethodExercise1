...
namespace Project1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"{userFirstName} {userLastName} with a {pet} named {petName} if you're feeling really clever and would like to see if you can do better");
            Console.WriteLine("Please if you like add a few lines so you can have a little fun to!!!"); 
